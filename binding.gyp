        ...
        ['OS=="win"', {
          "copies":[
            { 
              ...
              'files':[
                  "<(module_root_dir)/prebuilds/win32-x64/SDL2.dll",
                  "<(module_root_dir)/prebuilds/win32-x64/avcodec-58.dll",
                  "<(module_root_dir)/prebuilds/win32-x64/avutil-56.dll",
                  "<(module_root_dir)/prebuilds/win32-x64/avformat-58.dll",
                  "<(module_root_dir)/prebuilds/win32-x64/swscale-5.dll",
                  "<(module_root_dir)/prebuilds/win32-x64/swresample-3.dll",
              ]
            }
          ],
